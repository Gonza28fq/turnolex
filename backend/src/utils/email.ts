...
export const sendConfirmacionTurno = async (data: EmailTurno): Promise<void> => {
...
export const sendRecordatorioTurno = async (data: EmailTurno): Promise<void> => {
  const fechaFormateada = new Date(data.fecha).toLocaleDateString('es-AR', {
    weekday: 'long', year: 'numeric', month: 'long', day: 'numeric'
  });
  const horaFormateada = new Date(data.fecha).toLocaleTimeString('es-AR', {
...
// Email cancelación
export const sendCancelacionTurno = async (data: EmailTurno): Promise<void> => {
  const fechaFormateada = new Date(data.fecha).toLocaleDateString('es-AR', {
    weekday: 'long', year: 'numeric', month: 'long', day: 'numeric'
  });
