...
exports.generateTurnoPDF = void 0;
const pdfkit_1 = __importDefault(require("pdfkit"));
const generateTurnoPDF = (data, res) => {
    ...
    const drawSection = (title, fields, yPos) => {
    ...
    doc.fontSize(8).fillColor('rgba(255,255,255,0.5)').font('Helvetica')
        .text(`Comprobante generado el ${new Date().toLocaleDateString('es-AR')} a las ${new Date().toLocaleTimeString('es-AR', { hour: '2-digit', minute: '2-digit' })} — TurnoLex`, 50, doc.page.height - 38, { align: 'center', width: doc.page.width - 100 });
    doc.end();
};
exports.generateTurnoPDF = generateTurnoPDF;
